...
There are five other interaction states defined with tokens for each theme. Interaction tokens are assigned automatically through layered surfaces or colorways.  
